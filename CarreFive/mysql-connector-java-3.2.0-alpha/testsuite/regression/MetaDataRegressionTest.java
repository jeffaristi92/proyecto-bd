 ...
 * @version $Id: MetaDataRegressionTest.java,v 1.3.4.15.2.6 2004/12/23 16:25:43 mmatthew Exp $
 */
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    public void testGeorgsCatalogBug() throws Exception {
    	DatabaseMetaData dbmd = this.conn.getMetaData();
    	
    	assertTrue(dbmd.supportsCatalogsInTableDefinitions());
    	assertTrue(dbmd.supportsCatalogsInDataManipulation());
    	assertTrue(dbmd.supportsCatalogsInIndexDefinitions());
    	assertTrue(dbmd.supportsCatalogsInPrivilegeDefinitions());
    	assertTrue(dbmd.supportsCatalogsInProcedureCalls());
    }
