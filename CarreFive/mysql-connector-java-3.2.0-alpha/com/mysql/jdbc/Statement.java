 ...
 * @version $Id: Statement.java,v 1.20.4.34.2.8 2004/12/13 22:22:05 mmatthew Exp $
 *
...
public class Statement implements java.sql.Statement {
    ...
    protected synchronized java.sql.ResultSet getGeneratedKeysInternal()
        ...
        return new com.mysql.jdbc.ResultSet(this.currentCatalog, fields,
            new InMemoryRowProvider(rowSet), this.connection, this);
    }
     ...
     */
    protected static void checkNullOrEmptyQuery(String sql) throws SQLException {
        if (sql == null) {
