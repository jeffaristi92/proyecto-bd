...
lookForFirstChar: 
        while (true) {
            ...
            while (j < end) {
                ...
                if (Character.toUpperCase(searchIn.charAt(searchInPos)) != Character.toUpperCase(
                            searchFor.charAt(searchForPos))) {
                    i++;
                ...
                // Georgian and Turkish locales don't have same convention, so need to check lowercase
                // too!
                if (Character.toLowerCase(searchIn.charAt(searchInPos)) != Character.toLowerCase(
                        searchFor.charAt(searchForPos))) {
                	i++;
            ...
            if (searchForWildcard.charAt(searchForPos) == wildcardMany) { /* Found w_many */
                ...
                do {
                    while ((searchInPos != searchInEnd) &&
                            (Character.toUpperCase(searchIn.charAt(searchInPos)) != Character.toUpperCase(
                                cmp)))
                        searchInPos++;
