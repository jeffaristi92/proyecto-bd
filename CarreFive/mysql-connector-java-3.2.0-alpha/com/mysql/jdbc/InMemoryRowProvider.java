 ...
 *
 * @author dgan
 * @version $Id: InMemoryRowProvider.java,v 1.1.2.1 2004/09/28 10:03:22 mmatthew Exp $
 */
public class InMemoryRowProvider implements RowProvider {
    ResultSet owner;
    private List rows;
    private int index;
     ...
     */
    public InMemoryRowProvider(ArrayList rows) {
        this.index = -1;
        this.rows = rows;
    }
