 ...
 *
 * @author dgan
 * @version $Id: DirectRowProvider.java,v 1.1.2.2 2004/10/20 00:43:56 mmatthew Exp $
 */
public class DirectRowProvider implements RowProvider {
    //~ Instance fields --------------------------------------------------------
     ...
     */
    public DirectRowProvider(MysqlIO io, int colCount, Field[] fields, boolean isBinaryEncoded) throws SQLException {
        this.io = io;
    ...
    private void nextRecord() throws SQLException {
        ...
        try {
            if (!this.isAtEnd) {
            	...
            	boolean dontUnpackBinaryResults = false;
            	
            	if (this.owner != null) {
            		if (this.owner.connection != null) {
            			dontUnpackBinaryResults = this.owner.connection.getDontUnpackBinaryResults();
            		}
            	}
            	
                this.nextRow = this.io.nextRow(this.fields, 
                		this.columnCount, 
